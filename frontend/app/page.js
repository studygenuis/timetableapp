  ...
  return (
    <>
      ...
      <div className="relative text-black flex justify-center py-62">
        ...
        <div className="bg-white absolute top-9/12 right-3/12 animate-pulse p-1 pr-3 flex items-center gap-2 rounded-xl border w-max border-[#C3C3C3] cursor-pointer mt-3">
          <div className="bg-green-200 w-max py-1 px-2.5 rounded-lg">F</div>
        ...
        <div className="bg-white absolute top-7/12 right-9/12 animate-pulse p-1 pr-3 flex items-center gap-2 rounded-xl border w-max border-[#C3C3C3] cursor-pointer mt-3">
          <div className="bg-orange-200 w-max py-1 px-2.5 rounded-lg">E</div>
          <span className="text-black">Student 03</span>
        </div>
        <div className="bg-white absolute top-1/12 left-3/12 animate-pulse p-1 pr-3 flex items-center gap-2 rounded-xl border w-max border-[#C3C3C3] cursor-pointer mt-3">
          <div className="bg-yellow-200 w-max py-1 px-2.5 rounded-lg">H</div>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <button className="bg-white px-4 py-2 rounded-xl border border-[#C3C3C3] cursor-pointer mt-3 hover:-translate-y-1 transition duration-500">Get started</button>
        </div>
      </div>
    </>
  );
